...
// RUN: env ADORA_CGRA_ADG=%S/../../spec/cgra_cstore_vitra/artifacts/adg.json ADORA_CGRA_OP_FILE=%S/../../spec/cgra_cstore_vitra/artifacts/operations.json ADORA_CGEIST=/nonexistent ADORA_CONTROL_FLOW_OUT=%t.control-flow %S/../../../experiment/jyhu/control-flow/run.sh if_store
...
// IOB: operations: CSTORE, INPUT, LOAD, OUTPUT, STORE,
// IOB-NOT: CLOAD
